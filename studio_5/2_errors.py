...
def you_forgot_something():
    ...
    # Your Answer: Mathmatical vs Logical
...
def it_does_not_compute():
    ...
    # ERROR
    # TODO: What is the type of error for this? (What's in the place of xxxxxxx)
    # Your answer: Unsuppored Operand Type
...
def my_list_is_too_short():
    ...
    # TODO: What is the type of error for this?
    # Your answer: list index out of range
...
def make_your_own_error():
    ...
    x = 10 # Oops, this isn't between 1 and 10

    if x < 1 or x > 10:
        raise TypeError("The number must be between 1 and 10, you got: ", x)
